...
export const EventTypes: React.FC = () => {
  return (
    <section id="events" className="py-12 relative z-10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <h3 className="text-center text-2xl font-serif text-white mb-8 drop-shadow-lg">Perfect for Any Occasion</h3>
